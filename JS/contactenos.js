...
//Función que muestra una alerta de resultado exitoso
function mostrarAlerta() {
    Swal.fire({
        title: 'Muchas gracias',
        text: 'El equipo de Handel se contactará contigo.',
        icon: 'success', //Puedes cambiar el ícono (success, error, warning, info, etc.)
...
//Función que muestra una alerta de error
...
//Función en el text area para limitar la cantidad de caracteres
...
//Función que valida que el formato del correo esté de forma adecuada
